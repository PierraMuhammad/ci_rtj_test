...
<head>
    ...
    <meta name="author" content="MyDev">
...
<body data-spy="scroll" data-target="#navmenu" data-offset="70">
    ...
    <header id="header" class="header-section">
        <div class="container">
            <nav class="navbar">
                <a href="#" class="navbar-brand"><img src="<?= base_url('assets/') ?>img/logo.png" alt="Axuta"></a>
                <div class="d-flex menu-wrap">
                    ...
                    <div class="header-btn">
                        <a href="<?= base_url('auth') ?>"><button class="btn btn-primary">Login</button></a>
                    </div>
                </div>
            </nav>
        </div>
    ...
    <section id="home" class="hero-section">
        <div class="container">
            <div class="hero-content">
                ...
                <div class="btn-group">
                    <a href="#"><img src="<?= base_url('assets/') ?>img/appstore.png" alt="appstore"></a>
                    <a href="#"><img src="<?= base_url('assets/') ?>img/playstore.png" alt="playsotre"></a>
                </div>
            </div>
        </div>
            ...
            <div class="swiper-container">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img class="w-100" src="<?= base_url('assets/') ?>img/screenshot-1.jpg" alt="screenshot">
                    </div>
                    <div class="swiper-slide">
                        <img class="w-100" src="<?= base_url('assets/') ?>img/screenshot-2.jpg" alt="screenshot">
                    </div>
                    <div class="swiper-slide">
                        <img class="w-100" src="<?= base_url('assets/') ?>img/screenshot-3.jpg" alt="screenshot">
                    </div>
                    <div class="swiper-slide">
                        <img class="w-100" src="<?= base_url('assets/') ?>img/screenshot-4.jpg" alt="screenshot">
                    </div>
                    <div class="swiper-slide">
                        <img class="w-100" src="<?= base_url('assets/') ?>img/screenshot-5.jpg" alt="screenshot">
                    </div>
                    <div class="swiper-slide">
                        <img class="w-100" src="<?= base_url('assets/') ?>img/screenshot-6.jpg" alt="screenshot">
                    </div>
                    <div class="swiper-slide">
                        <img class="w-100" src="<?= base_url('assets/') ?>img/screenshot-7.jpg" alt="screenshot">
                    </div>
                    <div class="swiper-slide">
                        <img class="w-100" src="<?= base_url('assets/') ?>img/screenshot-8.jpg" alt="screenshot">
                    </div>
                </div>
                <!-- Carousel Arrows -->
            ...
            <div class="row d-flex align-items-center">
                <div class="col-md-6">
                    <div class="download-content">
                        ...
                        <div class="btn-group">
                            <a href="#"><img src="<?= base_url('assets/') ?>img/appstore.png" alt="btn"></a>
                            <a href="#"><img src="<?= base_url('assets/') ?>img/playstore.png" alt="btn"></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 xs-d-none">
                    <img src="<?= base_url('assets/') ?>img/download-moc.png" alt="mockup" />
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 xs-padding">
                    <div class="blog-box">
                        <div class="blog-thumb">
                            <img src="<?= base_url('assets/') ?>img/blog-1.jpg" alt="img">
                            <div class="post-meta">
                                <div>
                ...
                <div class="col-md-4 col-sm-6 xs-padding">
                    <div class="blog-box">
                        <div class="blog-thumb">
                            <img src="<?= base_url('assets/') ?>img/blog-2.jpg" alt="img">
                            <div class="post-meta">
                                <div>
                                    <span><i class="fa fa-user"></i>By: Admin</span>
                                    <span><i class="fa fa-calendar"></i>Jan 01, 2018</span>
                ...
                <div class="col-md-4 col-sm-6 xs-padding">
                    <div class="blog-box">
                        <div class="blog-thumb">
                            <img src="<?= base_url('assets/') ?>img/blog-3.jpg" alt="img">
                            <div class="post-meta">
                                <div>
                                    <span><i class="fa fa-user"></i>By: Admin</span>
                                    <span><i class="fa fa-calendar"></i>Jan 01, 2018</span>
    ...
    <div id="subscribe" class="subscribe-section padding">
        <div class="container text-center">
            <div class="subscribe-content">
                <img class="logo" src="<?= base_url('assets/') ?>img/footer-Logo.png" alt="logo" />
    ...
    <footer class="footer-section align-center">
        <div class="container">
            <p>&copy; Pierra - Web Developer 2024</p>
        </div>
    </footer>
    <!-- /.footer_section -->
